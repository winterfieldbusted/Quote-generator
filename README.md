This project is a simple yet functional Quote Generator built using HTML, CSS, and JavaScript. The application displays a random quote each time the user clicks the "I'm feeling lucky" button.
